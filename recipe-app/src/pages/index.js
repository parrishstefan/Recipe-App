  ...
  return (
    <div className="relative pb-16 sm:pb-24">
      ...
      <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-20">
          <div className="block">
            <h1 className="text-2xl font-bold mt-6">Protein Levels (grams)</h1>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 mt-3">
            <MultiRangeSlider
              min={0}
              max={1000}
          ...
          <div className="block">
            <h1 className="text-2xl font-bold mt-6">Calories (grams)</h1>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 mt-3">
            <MultiRangeSlider
              min={0}
              max={1000}
        ...
        <div className="mt-8 max-w-md mx-auto sm:flex sm:justify-center md:mt-12">
          <div className="rounded-md shadow">
            <Link legacyBehavior href={"/recipes/swipe"}>
              <a
